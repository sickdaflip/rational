...
class Rational_Ajax_ProductController extends Mage_Catalog_ProductController
{
        ...
        if ($product = $this->_initProduct()) {
            ...
            $result .= "<div class='product-essential'>
							...
							<div class='product-shop'>
								<h2 class='product-name'><a href='$productUrl'>" . $product->getName() . "</a></h2>";
            ...
            if ($product->getShortDescription()) {
                ...
                <div class='short-description'>" . $product->getShortDescription() . "</div>";
            }
			$result .= "<button class='button btn-cart' onclick=\"setLocation('$productUrl')\"><span><span>".Mage::helper('catalog')->__('zum Produkt')."</span></span></button>";
